...
// Auto-generated page for: Seasonal + promotional planning coordinated with marketing f

export default function CfSeasonalPromotionalPlanningCoordinate() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-seasonal-promotional-planning-coordinate', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Seasonal + promotional planning coordinated with marketing f</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Seasonal + promotional planning coordinated with marketing for optimal sell-through.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Seasonal + promotional planning coordinated with marketing f'}
        </button>
      </form>
