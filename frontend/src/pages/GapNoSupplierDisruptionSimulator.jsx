...
// Auto-generated page for: No supplier-disruption simulator

export default function GapNoSupplierDisruptionSimulator() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-supplier-disruption-simulator', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No supplier-disruption simulator</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No supplier-disruption simulator</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No supplier-disruption simulator'}
        </button>
      </form>
