...
// Auto-generated page for: Multi-warehouse network optimization recommending transfers 

export default function CfMultiWarehouseNetworkOptimizationRec() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-multi-warehouse-network-optimization-rec', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Multi-warehouse network optimization recommending transfers </h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Multi-warehouse network optimization recommending transfers and diversification.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Multi-warehouse network optimization recommending transfers '}
        </button>
      </form>
