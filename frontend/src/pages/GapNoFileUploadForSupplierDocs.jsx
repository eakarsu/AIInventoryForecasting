...
// Auto-generated page for: No file upload for supplier docs

export default function GapNoFileUploadForSupplierDocs() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-file-upload-for-supplier-docs', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No file upload for supplier docs</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No file upload for supplier docs</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No file upload for supplier docs'}
        </button>
      </form>
