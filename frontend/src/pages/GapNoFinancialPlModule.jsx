...
// Auto-generated page for: No financial P&L module

export default function GapNoFinancialPlModule() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-financial-pl-module', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No financial P&L module</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No financial P&L module</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No financial P&L module'}
        </button>
      </form>
