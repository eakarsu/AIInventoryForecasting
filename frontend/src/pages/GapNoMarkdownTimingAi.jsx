...
// Auto-generated page for: No markdown-timing AI

export default function GapNoMarkdownTimingAi() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-markdown-timing-ai', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No markdown-timing AI</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No markdown-timing AI</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No markdown-timing AI'}
        </button>
      </form>
