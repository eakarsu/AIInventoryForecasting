...
// Auto-generated page for: No SKU-rationalization (which SKUs to discontinue) AI

export default function GapNoSkuRationalizationWhichSkusTo() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-sku-rationalization-which-skus-to', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No SKU-rationalization (which SKUs to discontinue) AI</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No SKU-rationalization (which SKUs to discontinue) AI</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No SKU-rationalization (which SKUs to discontinue) AI'}
        </button>
      </form>
