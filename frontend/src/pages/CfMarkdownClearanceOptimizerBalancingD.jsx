...
// Auto-generated page for: Markdown + clearance optimizer balancing dead-stock clearanc

export default function CfMarkdownClearanceOptimizerBalancingD() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-markdown-clearance-optimizer-balancing-d', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Markdown + clearance optimizer balancing dead-stock clearanc</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Markdown + clearance optimizer balancing dead-stock clearance against margin protection.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Markdown + clearance optimizer balancing dead-stock clearanc'}
        </button>
      </form>
